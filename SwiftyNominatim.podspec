...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftyNominatim.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kar_mad_on/SwiftyNominatim'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kar_mad_on' => 'stremovskyy@me.com' }
  s.source           = { :git => 'https://github.com/kar_mad_on/SwiftyNominatim.git', :tag => s.version.to_s }
